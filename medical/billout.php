...
<body style="background: #ECF0F5; padding:0; margin:0">
  ...
  ?>
  <tr>
    <td colspan="3" style="text-align: right;">Gross Total</td><th>NGN <?php echo $total; ?></th>
  </tr>
  <tr>
    <td colspan="3" style="text-align: right;">Discount</td><th style="border-bottom: 1px solid blue;">NGN <?php echo $_POST['discount']; ?></th>
  </tr>
  <tr>
    <td colspan="3" style="text-align: right;border-right: 1px solid blue">Gross Total</td><th style="border: 1px solid blue;">NGN <?php echo $total-$_POST['discount']; ?></th>
  </tr>
  <tr>
